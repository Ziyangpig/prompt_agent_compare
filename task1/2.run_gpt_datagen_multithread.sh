...
output_path="./data/3.exam_aft_${model_name}_${prompt}_rag_${rag}.jsonl"

python "$python_script" --model_name "$model_name" --keys_path "$keys_path" --input_path "$input_path" --output_path "$output_path" --max_workers $max_workers --base_url $base_url
